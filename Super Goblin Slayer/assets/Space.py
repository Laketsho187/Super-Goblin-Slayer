...
# Laser Beam
Red_Laser = pygame.transform.scale(pygame.image.load(os.path.join("assets", "Red Laser.png")), (20, 20))
Purple_Laser = pygame.transform.scale(pygame.image.load(os.path.join("assets", "Purple Laser.png")), (20, 20))
Blue_Laser = pygame.transform.scale(pygame.image.load(os.path.join("assets", "Blue Laser.png")), (20, 20))
